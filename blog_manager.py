...
class BlogManager:
    ...
    def create_daily_post(self, title, content, category="PDF Tips", tags=None, excerpt=None):
        """Create a new daily blog post (disabled for AdSense compliance)"""
        print("ℹ️ Programmatic blog creation is disabled to comply with Google AdSense quality guidelines.")
        return None
...
<body>
    <nav class="site-nav" id="siteNav">
        <a href="../index.html" class="nav-logo"><div class="nav-logo-heart">
